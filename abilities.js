...
const classes = {
    ...
    rogue: {
        abilities: [
            {
                name: 'Expertise',
                description: `Choose two of your skill proficiencies, or
            ...
            {
                name: 'Expertise 2',
                description: `Choose two more of your proficiencies 
                (in skills or with thieves’ tools). 
            ...
            },
            {
                ...
                The amount of the extra damage increases as you gain levels in this class (your level, divided by two and rounded up).`,
                requiredLevel: 1,
            },
            {
                name: 'Thieves\' Cant',
